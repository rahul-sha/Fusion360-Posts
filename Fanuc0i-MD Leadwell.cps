/**
  ...
  $Revision: 43491 7c5e27ae46336e64aeded77bffc5c259a90bdb03 $
  $Date: 2021-11-01 14:51:58 $

  FORKID {04622D27-72F0-45d4-85FB-DB346FD1AE22}
*/

description = "FANUC 0i-MD";
vendor = "FANUC 0i-MD W/S 81";
vendorUrl = "http://www.fanuc.com";
legal = "Copyright (C) 2012-2021 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 45702;

longDescription = "Generic post for Fanuc. To be used in Leadwell";
...
function activateMachine() {
	...
	safeRetractDistance =
		getProperty("safeRetractDistance") != undefined
			? getProperty("safeRetractDistance")
			: typeof safeRetractDistance == "number"
			? safeRetractDistance
			: 0;
	if (
		machineConfiguration.performRewinds() ||
		(typeof performRewinds == "undefined" ? false : performRewinds)
	) {
	...
	if (machineConfiguration.isHeadConfiguration()) {
		...
		virtualTooltip =
			typeof virtualTooltip == "undefined" ? false : virtualTooltip;
